...
public class CLayout {
	...
	public CLayout() {
		...
		panelLog.LogButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0){
				if((username.equals(panelLog.Login_username.getText()))&&(password.equals(panelLog.Login_password.getText()))){
					JOptionPane.showMessageDialog(null,"Login successful!");
					cl.show(panelCont, "Main");
				}
				else{
					JOptionPane.showMessageDialog(null,"Login failed T^T");
				}
			}
		});
		...
		panelReg.RegButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0){
				cl.show(panelCont, "Log");
				username=panelReg.Register_username.getText();
				password=panelReg.Register_password.getText();
			}
		});
	...
	class FocusHandler extends FocusAdapter{
    	public void focusGained(FocusEvent e) {
    		...
    		if(("".equals(panelLog.Login_password.getText()))|("password".equals(panelLog.Login_password.getText()))){
        	}
        	else{
        		panelLog.Login_password.setEchoChar('*');
        	}
    	...
    	public void focusLost(FocusEvent e) {
    		...
    		if(e.getSource()==panelLog.Login_password){
    			if("".equals(panelLog.Login_password.getText()))
    				...
    				panelLog.Login_password.setEchoChar((char) (0));
    		}
    		if(("".equals(panelLog.Login_password.getText()))|("password".equals(panelLog.Login_password.getText()))){
        	}
        	else{
